...
//* Первую задачу сделать в двух вариантах: при помощи строки и при помощи целочисленного массива (вычисление каждого разряда и формирование массива)
//* Сделать задачу 1 для любых возможных чисел типа int
